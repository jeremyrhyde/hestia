...
upsert_scene '{
  ...
  "actions": [
    ...
    { "device_id": "living-room-light-1", "action": "set_brightness", "params": { "level": 100 }, "delay_ms": 2000 },
    { "device_id": "living-room-light-2", "action": "set_brightness", "params": { "level": 100 } },
